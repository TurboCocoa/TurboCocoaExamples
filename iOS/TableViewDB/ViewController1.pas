unit ViewController1;

interface

uses
  System.SysUtils, System.TypInfo, System.Classes, System.Types, System.Rtti, Macapi.ObjectiveC, Macapi.ObjCRuntime,
   Macapi.CoreFoundation, iOSapi.Foundation, iOSapi.CocoaTypes, iOSapi.UIKit, Macapi.Helpers, CocoaTouch, Unit1;
...
begin
  ...
  Result.textLabel.setText(NSStr(DataModule1.FDTable1Name.AsString));
  Result.detailTextLabel.setText(NSStr(DataModule1.FDTable1Department.AsString));
end;
